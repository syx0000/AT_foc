...
#if defined AT32F421xx || defined AT32F423xx || defined AT32F435xx || defined AT32F437xx
...
#if defined AT32F413xx || defined AT32F415xx || defined AT32F403Axx || defined AT32F407xx
...
#if defined AT32F423xx || defined AT32F435xx || defined AT32F437xx
  spi_init_struct.mclk_freq_division = SPI_MCLK_DIV_32; // spi clock for AT32F423xx = 150/32=4.6875MHz, AT32F435xx = 144/32=4.5MHz
#else
  spi_init_struct.mclk_freq_division = SPI_MCLK_DIV_16; //spi clock for AT32F413xx = 100/16=6.25MHz, AT32F403Axx & AT32F421xx = 120/16=7.5MHz, AT32F415xx = 75/16=4.6875MHz
#endif
