/**
  **************************************************************************
  * @file     mc_foc_esc_state_incremental_encoder.c
  * @brief    State Machine Switching of Motor Vector Control in Incremental Encoder Sensor-Based
  **************************************************************************
...
/** @defgroup mc_foc_esc_state_incremental_encoder
  * @brief State Machine Switching of Motor Vector Control in Incremental Encoder Sensor-Based Motor.
  * @{
  */
/**
