...
/** @addtogroup AT32F45x_system_private_defines
  * @{
  */
...
/** @addtogroup AT32F45x_system_private_variables
  * @{
  */
...
/** @addtogroup AT32F45x_system_private_functions
  * @{
  */
...
void system_core_clock_update(void)
{
  ...
  switch(sclk_source)
  {
    ...
    case CRM_SCLK_PLL:
      ...
      system_core_clock = (uint32_t)(((uint64_t)pllrcsfreq * pll_ns) / (pll_ms * pll_fp));
      break;
    default:
      system_core_clock = HICK_VALUE;
      break;
