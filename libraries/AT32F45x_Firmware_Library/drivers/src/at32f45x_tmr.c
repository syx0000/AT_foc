...
/**
  ...
  * @param  tmr_x: select the tmr peripheral.
  *         this parameter can be one of the following values:
  *         TMR1, TMR8, TMR9, TMR10, TMR11, TMR12, TMR13, TMR14
  * @param  tmr_rpr_value (for TMR1, TMR8 0x0000~0xFFFF,
  *                        for other tmr 0x00~0xFF)
  * @retval none
  */
...
/**
  ...
  *         TMR2, TMR5
  * @param  input_remap
  *         - TMR2_TMR8TRGOUT_TMR5_GPIO_TMR14_GPIO
  *         - TMR2_EMAC_PTP_TMR5_LICK_TMR14_ERTC_CLK
  *         - TMR2_USB_SOF_TMR5_LEXT_TMR14_HEXT_DIV
  *         - TMR5_ERTC_WKUP_TMR14_CLKOUT
  * @retval none
  */
