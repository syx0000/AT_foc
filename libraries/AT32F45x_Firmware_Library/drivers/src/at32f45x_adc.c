...
/**
  * @brief  adc common default para init.
  * @param  combine_mode: configure the adc combine_mode.
  *         this parameter can be one of the following values:
  *         - ADC_INDEPENDENT_MODE                       - ADC_ORDINARY_SMLT_PREEMPT_SMLT_ONESLAVE_MODE   - ADC_ORDINARY_SMLT_PREEMPT_INTERLTRIG_ONESLAVE_MODE
  *         - ADC_PREEMPT_SMLT_ONLY_ONESLAVE_MODE        - ADC_ORDINARY_SMLT_ONLY_ONESLAVE_MODE           - ADC_ORDINARY_SHIFT_ONLY_ONESLAVE_MODE
...
/**
  ...
  *         - ADC_ORDINARY_TRIG_TMR8TRGOUT2 - ADC_ORDINARY_TRIG_TMR1TRGOUT2  - ADC_ORDINARY_TRIG_TMR4TRGOUT   - ADC_ORDINARY_TRIG_TMR6TRGOUT
  *         - ADC_ORDINARY_TRIG_TMR3CH4     - ADC_ORDINARY_TRIG_TMR4CH1      - ADC_ORDINARY_TRIG_TMR1TRGOUT   - ADC_ORDINARY_TRIG_TMR2CH1
  *         - ADC_ORDINARY_TRIG_TMR7TRGOUT
...
/**
  ...
  *         - ADC_PREEMPT_TRIG_TMR1TRGOUT2  - ADC_PREEMPT_TRIG_TMR8TRGOUT   - ADC_PREEMPT_TRIG_TMR8TRGOUT2 - ADC_PREEMPT_TRIG_TMR3CH3
  *         - ADC_PREEMPT_TRIG_TMR3TRGOUT   - ADC_PREEMPT_TRIG_TMR3CH1      - ADC_PREEMPT_TRIG_TMR6TRGOUT  - ADC_PREEMPT_TRIG_TMR4CH4
  *         - ADC_PREEMPT_TRIG_TMR1CH3      - ADC_PREEMPT_TRIG_TMR7TRGOUT
