...
/**
  ...
  *         type 4: depslp_wdt, wdt stop count when entering deepsleep mode.
  *         this data can be one of the following values:
  ...
  *         type 5: stdby_wdt, wdt stop count when entering standby mode.
  *         this data can be one of the following values:
  ...
  *         type 6: ram_prt_chk, wdt stop count when entering standby mode.
