...
void crm_reset(void)
{
  ...
  /* reset pllms pllns pllfp pllrcs bits */
...
/**
  ...
  *         - CRM_CRC_PERIPH_CLOCK          - CRM_DMA1_PERIPH_CLOCK         - CRM_DMA2_PERIPH_CLOCK        - CRM_EMAC_PERIPH_CLOCK
  *         - CRM_EMACTX_PERIPH_CLOCK       - CRM_EMACRX_PERIPH_CLOCK       - CRM_EMACPTP_PERIPH_CLOCK     - CRM_AES_PERIPH_CLOCK
  *         - CRM_TRNG_PERIPH_CLOCK         - CRM_OTGFS1_PERIPH_CLOCK       - CRM_SDIO1_PERIPH_CLOCK       - CRM_XMC_PERIPH_CLOCK
  *         - CRM_QSPI1_PERIPH_CLOCK        - CRM_TMR2_PERIPH_CLOCK         - CRM_TMR3_PERIPH_CLOCK        - CRM_TMR4_PERIPH_CLOCK
  *         - CRM_TMR5_PERIPH_CLOCK         - CRM_TMR6_PERIPH_CLOCK         - CRM_TMR7_PERIPH_CLOCK        - CRM_TMR12_PERIPH_CLOCK
  ...
  *         - CRM_CAN1_PERIPH_CLOCK         - CRM_CAN2_PERIPH_CLOCK         - CRM_CAN3_PERIPH_CLOCK        - CRM_PWC_PERIPH_CLOCK
  *         - CRM_DAC_PERIPH_CLOCK          - CRM_USART7_PERIPH_CLOCK       - CRM_USART8_PERIPH_CLOCK      - CRM_TMR1_PERIPH_CLOCK
  *         - CRM_TMR8_PERIPH_CLOCK         - CRM_USART1_PERIPH_CLOCK       - CRM_USART6_PERIPH_CLOCK      - CRM_ADC2_PERIPH_CLOCK
  *         - CRM_ADC1_PERIPH_CLOCK         - CRM_SPI1_PERIPH_CLOCK         - CRM_SPI4_PERIPH_CLOCK        - CRM_SCFG_PERIPH_CLOCK
  *         - CRM_TMR9_PERIPH_CLOCK         - CRM_TMR10_PERIPH_CLOCK        - CRM_TMR11_PERIPH_CLOCK       - CRM_I2SF5_PERIPH_CLOCK
  *         - CRM_ACC_PERIPH_CLOCK          - CRM_I2S2EXT_PERIPH_CLOCK      - CRM_I2S3EXT_PERIPH_CLOCK
  * @param  new_state (TRUE or FALSE)
  * @retval none
  */
...
/**
  ...
  *         - CRM_CRC_PERIPH_RESET          - CRM_DMA1_PERIPH_RESET         - CRM_DMA2_PERIPH_RESET        - CRM_EMAC_PERIPH_RESET
  *         - CRM_AES_PERIPH_RESET          - CRM_TRNG_PERIPH_RESET         - CRM_OTGFS1_PERIPH_RESET      - CRM_SDIO1_PERIPH_RESET
  *         - CRM_XMC_PERIPH_RESET          - CRM_QSPI1_PERIPH_RESET        - CRM_TMR2_PERIPH_RESET        - CRM_TMR3_PERIPH_RESET
  *         - CRM_TMR4_PERIPH_RESET         - CRM_TMR5_PERIPH_RESET         - CRM_TMR6_PERIPH_RESET        - CRM_TMR7_PERIPH_RESET
  *         - CRM_TMR12_PERIPH_RESET        - CRM_TMR13_PERIPH_RESET        - CRM_TMR14_PERIPH_RESET       - CRM_WWDT_PERIPH_RESET
  *         - CRM_SPI2_PERIPH_RESET         - CRM_SPI3_PERIPH_RESET         - CRM_USART2_PERIPH_RESET      - CRM_USART3_PERIPH_RESET
  *         - CRM_USART4_PERIPH_RESET       - CRM_USART5_PERIPH_RESET       - CRM_I2C1_PERIPH_RESET        - CRM_I2C2_PERIPH_RESET
  *         - CRM_I2C3_PERIPH_RESET         - CRM_CAN1_PERIPH_RESET         - CRM_CAN2_PERIPH_RESET        - CRM_CAN3_PERIPH_RESET
  *         - CRM_PWC_PERIPH_RESET          - CRM_DAC_PERIPH_RESET          - CRM_USART7_PERIPH_RESET      - CRM_USART8_PERIPH_RESET
  *         - CRM_TMR1_PERIPH_RESET         - CRM_TMR8_PERIPH_RESET         - CRM_USART1_PERIPH_RESET      - CRM_USART6_PERIPH_RESET
  *         - CRM_ADC2_PERIPH_RESET         - CRM_ADC1_PERIPH_RESET         - CRM_SPI1_PERIPH_RESET        - CRM_SPI4_PERIPH_RESET
  *         - CRM_SCFG_PERIPH_RESET         - CRM_TMR9_PERIPH_RESET         - CRM_TMR10_PERIPH_RESET       - CRM_TMR11_PERIPH_RESET
  *         - CRM_I2SF5_PERIPH_RESET        - CRM_ACC_PERIPH_RESET          - CRM_I2S2EXT_PERIPH_RESET     - CRM_I2S3EXT_PERIPH_RESET
  * @param  new_state (TRUE or FALSE)
  * @retval none
  */
...
/**
  ...
  *         - CRM_CRC_PERIPH_LOWPOWER       - CRM_DMA1_PERIPH_LOWPOWER      - CRM_DMA2_PERIPH_LOWPOWER     - CRM_EMAC_PERIPH_LOWPOWER
  *         - CRM_EMACTX_PERIPH_LOWPOWER    - CRM_EMACRX_PERIPH_LOWPOWER    - CRM_EMACPTP_PERIPH_LOWPOWER  - CRM_AES_PERIPH_LOWPOWER
  *         - CRM_TRNG_PERIPH_LOWPOWER      - CRM_OTGFS1_PERIPH_LOWPOWER    - CRM_SDIO1_PERIPH_LOWPOWER    - CRM_XMC_PERIPH_LOWPOWER
  *         - CRM_QSPI1_PERIPH_LOWPOWER     - CRM_TMR2_PERIPH_LOWPOWER      - CRM_TMR3_PERIPH_LOWPOWER     - CRM_TMR4_PERIPH_LOWPOWER
  *         - CRM_TMR5_PERIPH_LOWPOWER      - CRM_TMR6_PERIPH_LOWPOWER      - CRM_TMR7_PERIPH_LOWPOWER     - CRM_TMR12_PERIPH_LOWPOWER
  ...
  *         - CRM_CAN1_PERIPH_LOWPOWER      - CRM_CAN2_PERIPH_LOWPOWER      - CRM_CAN3_PERIPH_LOWPOWER     - CRM_PWC_PERIPH_LOWPOWER
  *         - CRM_DAC_PERIPH_LOWPOWER       - CRM_USART7_PERIPH_LOWPOWER    - CRM_USART8_PERIPH_LOWPOWER   - CRM_TMR1_PERIPH_LOWPOWER
  *         - CRM_TMR8_PERIPH_LOWPOWER      - CRM_USART1_PERIPH_LOWPOWER    - CRM_USART6_PERIPH_LOWPOWER   - CRM_ADC2_PERIPH_LOWPOWER
  *         - CRM_ADC1_PERIPH_LOWPOWER      - CRM_SPI1_PERIPH_LOWPOWER      - CRM_SPI4_PERIPH_LOWPOWER     - CRM_SCFG_PERIPH_LOWPOWER
  *         - CRM_TMR9_PERIPH_LOWPOWER      - CRM_TMR10_PERIPH_LOWPOWER     - CRM_TMR11_PERIPH_LOWPOWER    - CRM_I2SF5_PERIPH_LOWPOWER
  *         - CRM_ACC_PERIPH_LOWPOWER       - CRM_I2S2EXT_PERIPH_LOWPOWER   - CRM_I2S3EXT_PERIPH_LOWPOWER
  * @param  new_state (TRUE or FALSE)
  * @retval none
  */
...
void crm_can_clock_select(crm_can_type can_index, crm_can_clock_source_type value)
{
  switch(can_index)
  {
    case CRM_CAN1:
      ...
      break;
    case CRM_CAN2:
      CRM->piclks_bit.can2_clksel = value;
      break;
    case CRM_CAN3:
      CRM->piclks_bit.can3_clksel = value;
      break;
  }
}
...
crm_can_clock_source_type crm_can_clock_get(crm_can_type can_index)
{
  ...
  switch(can_index)
  {
    case CRM_CAN1:
      ...
      break;
    case CRM_CAN2:
      value = (crm_can_clock_source_type)CRM->piclks_bit.can2_clksel;
      break;
    case CRM_CAN3:
      value = (crm_can_clock_source_type)CRM->piclks_bit.can3_clksel;
      break;
  }
...
{
  uint32_t pll_ns = 0, pll_ms = 0, pll_fp = 0, pll_clock_source = 0, pllrcsfreq = 0;
  ...
  switch(sclk_source)
  {
    ...
    case CRM_SCLK_PLL:
      ...
      pll_fp = pll_fp_table[CRM->pllcfg_bit.pllfp];
      ...
      clocks_struct->sclk_freq = (uint32_t)(((uint64_t)pllrcsfreq * pll_ns) / (pll_ms * pll_fp));
      break;
    default:
      clocks_struct->sclk_freq = HICK_VALUE;
      break;
...
/**
  ...
  * @param  ret_fp: pointer to fr value, return the pll_fp of pll parameters
