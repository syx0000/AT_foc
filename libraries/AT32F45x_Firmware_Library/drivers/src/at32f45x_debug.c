...
/**
  ...
  *         - DEBUG_TMR2_PAUSE                      - DEBUG_TMR5_PAUSE
  *         - DEBUG_TMR6_PAUSE                      - DEBUG_TMR7_PAUSE
  *         - DEBUG_TMR12_PAUSE                     - DEBUG_TMR13_PAUSE
  *         - DEBUG_TMR14_PAUSE                     - DEBUG_WDT_PAUSE
  *         - DEBUG_I2C1_SMBUS_TIMEOUT              - DEBUG_I2C2_SMBUS_TIMEOUT
  *         - DEBUG_I2C3_SMBUS_TIMEOUT
  * @param  new_state (TRUE or FALSE) 
  * @retval none
  */
