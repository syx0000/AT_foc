/**
  **************************************************************************
  * @file     at32f45x_dma.h
  * @brief    at32f45x dma header file
  **************************************************************************
...
#ifndef __AT32F45x_DMA_H
#define __AT32F45x_DMA_H
...
typedef enum
{
  ...
  DMAMUX_DMAREQ_ID_USART4_RX             = 0x1E, /*!< dmamux channel dma request inputs resources: usart4_rx */
  DMAMUX_DMAREQ_ID_USART4_TX             = 0x1F, /*!< dmamux channel dma request inputs resources: usart4_tx */
  DMAMUX_DMAREQ_ID_USART5_RX             = 0x20, /*!< dmamux channel dma request inputs resources: usart5_rx */
  DMAMUX_DMAREQ_ID_USART5_TX             = 0x21, /*!< dmamux channel dma request inputs resources: usart5_tx */
  ...
  DMAMUX_DMAREQ_ID_USART7_RX             = 0x74, /*!< dmamux channel dma request inputs resources: usart7_rx */
  DMAMUX_DMAREQ_ID_USART7_TX             = 0x75, /*!< dmamux channel dma request inputs resources: usart7_tx */
  DMAMUX_DMAREQ_ID_USART8_RX             = 0x76, /*!< dmamux channel dma request inputs resources: usart8_rx */
  DMAMUX_DMAREQ_ID_USART8_TX             = 0x77, /*!< dmamux channel dma request inputs resources: usart8_tx */
  ...
  DMAMUX_DMAREQ_ID_TMR12_HALL            = 0x62, /*!< dmamux channel dma request inputs resources: timer12 hall */
  ...
  DMAMUX_DMAREQ_ID_AES_IN                = 0x5B, /*!< dmamux channel dma request inputs resources: aes_in */
  DMAMUX_DMAREQ_ID_AES_OUT               = 0x5C, /*!< dmamux channel dma request inputs resources: aes_out */
