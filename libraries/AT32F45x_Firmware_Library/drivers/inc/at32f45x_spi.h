/**
  **************************************************************************
  * @file     at32f45x_spi.h
  * @brief    at32f45x spi header file
  **************************************************************************
...
#ifndef __AT32F45x_SPI_H
#define __AT32F45x_SPI_H
...
typedef struct
{
  ...
  uint32_t                               i2s_ckin_value;             /*!< i2s clock input walue */
  i2s_pcm_sample_clock_type              pcm_sample_clock_selection; /*!< i2s pcm mode sample clock selection */
} i2s_init_type;
