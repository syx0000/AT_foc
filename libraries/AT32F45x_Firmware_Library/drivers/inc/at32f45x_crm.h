/**
  **************************************************************************
  * @file     at32f45x_crm.h
  * @brief    at32f45x crm header file
  **************************************************************************
...
#ifndef __AT32F45x_CRM_H
#define __AT32F45x_CRM_H
...
typedef enum
{
  ...
  CRM_EMACTX_PERIPH_CLOCK                = MAKE_VALUE(0x30, 26), /*!< emactx periph clock */
  CRM_EMACRX_PERIPH_CLOCK                = MAKE_VALUE(0x30, 27), /*!< emacrx periph clock */
  CRM_EMACPTP_PERIPH_CLOCK               = MAKE_VALUE(0x30, 28), /*!< emacptp periph clock */
  /* ahb periph2 */
  CRM_AES_PERIPH_CLOCK                   = MAKE_VALUE(0x34, 4),  /*!< aes periph clock */
  CRM_TRNG_PERIPH_CLOCK                  = MAKE_VALUE(0x34, 6),  /*!< trng periph clock */
  ...
  CRM_CAN3_PERIPH_CLOCK                  = MAKE_VALUE(0x40, 27), /*!< can3 periph clock */
  ...
  CRM_I2S2EXT_PERIPH_CLOCK               = MAKE_VALUE(0x44, 30), /*!< i2s2ext periph clock */
  CRM_I2S3EXT_PERIPH_CLOCK               = MAKE_VALUE(0x44, 31)   /*!< i2s3ext periph clock */
...
typedef enum
{
  ...
  /* ahb periph2 */
  CRM_AES_PERIPH_RESET                   = MAKE_VALUE(0x14, 4),  /*!< aes periph clock reset */
  CRM_TRNG_PERIPH_RESET                  = MAKE_VALUE(0x14, 6),  /*!< trng periph clock reset */
  ...
  CRM_CAN3_PERIPH_RESET                  = MAKE_VALUE(0x20, 27), /*!< can3 periph reset */
  ...
  CRM_I2S2EXT_PERIPH_RESET               = MAKE_VALUE(0x24, 30), /*!< i2s2ext periph reset */
  CRM_I2S3EXT_PERIPH_RESET               = MAKE_VALUE(0x24, 31)  /*!< i2s3ext periph reset */
...
typedef enum
{
  ...
  CRM_EMACTX_PERIPH_LOWPOWER             = MAKE_VALUE(0x50, 26), /*!< emactx sleep mode periph clock */
  CRM_EMACRX_PERIPH_LOWPOWER             = MAKE_VALUE(0x50, 27), /*!< emacrx sleep mode periph clock */
  CRM_EMACPTP_PERIPH_LOWPOWER            = MAKE_VALUE(0x50, 28), /*!< emacptp sleep mode periph clock */
  /* ahb periph2 */
  CRM_AES_PERIPH_LOWPOWER                = MAKE_VALUE(0x54, 4), /*!< aes sleep mode periph clock */
  CRM_TRNG_PERIPH_LOWPOWER               = MAKE_VALUE(0x54, 6), /*!< trng sleep mode periph clock */
  ...
  CRM_CAN3_PERIPH_LOWPOWER               = MAKE_VALUE(0x60, 27), /*!< can3 sleep mode periph clock */
  ...
  CRM_I2S2EXT_PERIPH_LOWPOWER            = MAKE_VALUE(0x64, 30), /*!< i2s2ext sleep mode periph clock */
  CRM_I2S3EXT_PERIPH_LOWPOWER            = MAKE_VALUE(0x64, 31)  /*!< i2s3ext sleep mode periph clock */
...
typedef enum
{
  ...
  CRM_PLL_FU_12                          = 0x01, /*!< pll fu-division div12 */
  CRM_PLL_FU_13                          = 0x02, /*!< pll fu-division div13 */
...
typedef enum
{
  ...
  CRM_CLKOUT_USB                         = 0x10, /*!< output usbclk to clkout pin */
...
typedef enum
{
  ...
  CRM_CAN_CLOCK_SOURCE_PLLU              = 0x01, /*!< select pllu clock as can clock source */
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved2            : 4; /* [11:8] */
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t aesrst               : 1; /* [4] */
      __IO uint32_t reserved2            : 1; /* [5] */
      __IO uint32_t trngrst              : 1; /* [6] */
      __IO uint32_t otgfs1rst            : 1; /* [7] */
      __IO uint32_t reserved3            : 7; /* [14:8] */
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t i2s2extrst           : 1; /* [30] */
      __IO uint32_t i2s3extrst           : 1; /* [31] */
    } apb2rst_bit;
  };
  ...
  union
  {
    ...
    {
      __IO uint32_t reserved1            : 4; /* [3:0] */
      __IO uint32_t aesen                : 1; /* [4] */
      __IO uint32_t reserved2            : 1; /* [5] */
      __IO uint32_t trngen               : 1; /* [6] */
  ...
  union
  {
    ...
    struct
    {
      __IO uint32_t xmcen                : 1; /* [1] */
      __IO uint32_t reserved2            : 31;/* [31:1] */
    } ahben3_bit;
  };
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t i2s2exten            : 1; /* [30] */
      __IO uint32_t i2s3exten            : 1; /* [31] */
    } apb2en_bit;
  };
  ...
  union
  {
    ...
    {
      __IO uint32_t reserved1            : 4; /* [3:0] */
      __IO uint32_t aeslpen              : 1; /* [4] */
      __IO uint32_t reserved2            : 1; /* [5] */
      __IO uint32_t trnglpen             : 1; /* [6] */
      __IO uint32_t otgfs1lpen           : 1; /* [7] */
      __IO uint32_t reserved3            : 7; /* [14:7] */
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t i2s2extlpen          : 1; /* [30] */
      __IO uint32_t i2s3extlpen          : 1; /* [31] */
    } apb2lpen_bit;
  };

  /**
    * @brief crm piclk register, offset:0x68
    */
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t can2_clksel          : 2; /* [27:26] */
      __IO uint32_t can3_clksel          : 2; /* [29:28] */
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved1            : 6; /* [13:8] */
...
void crm_pll_config(crm_pll_clock_source_type clock_source, uint16_t pll_ns, \
                    uint16_t pll_ms, crm_pll_fp_type pll_fr);
