/**
  **************************************************************************
  * @file     at32f45x_tmr.h
  * @brief    at32f45x tmr header file
  **************************************************************************
...
#ifndef __AT32F45x_TMR_H
#define __AT32F45x_TMR_H
...
typedef enum
{
  ...
  TMR_SELECT_CHANNEL_4C                  = 0x07, /*!< tmr channel select channel 4 complementary */
  TMR_SELECT_CHANNEL_5                   = 0x08  /*!< tmr channel select channel 5 */
...
typedef enum
{
  TMR2_TMR8TRGOUT_TMR5_GPIO_TMR14_GPIO   = 0x00, /*!< tmr2 input remap to tmr8_trgout or tmr5 remap to gpio or tmr14 remap to gpio */
  TMR2_EMAC_PTP_TMR5_LICK_TMR14_ERTC_CLK = 0x01, /*!< tmr2 input remap to emac ptp or tmr5 remap to lick or tmr14 remap to ertc clock */
  TMR2_USB_SOF_TMR5_LEXT_TMR14_HEXT_DIV  = 0x02, /*!< tmr2 input remap to usb sof or tmr5 remap to lext or tmr14 remap to hext divider */
  TMR5_ERTC_WKUP_TMR14_CLKOUT            = 0x03  /*!< tmr5 remap to ertc wkup or tmr14 remap to clock out */
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t c4cios               : 1; /* [15] */
      __IO uint32_t reserved2            : 15;/* [30:16] */
