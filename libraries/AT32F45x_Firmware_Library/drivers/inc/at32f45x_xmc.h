/**
  **************************************************************************
  * @file     at32f45x_xmc.h
  * @brief    at32f45x xmc header file
  **************************************************************************
...
#ifndef __AT32F45x_XMC_H
#define __AT32F45x_XMC_H
...
typedef enum
{
  ...
  XMC_CLKDIV_1                           = 0x00000010,  /*!< xmc sdram clock div 1 */
...
/**
  ...
  /**
    * @brief xmc sdram clkdiv1, offset:0x180
    */
  union
  {
