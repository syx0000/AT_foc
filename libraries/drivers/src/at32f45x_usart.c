...
/**
  ...
  *         - USART_CTSCF_FLAG: cts change flag (not available for USART5, USART7 and USART8)
...
/**
  ...
  *         - USART_CMDF_FLAG:   character match detection flag
  *         - USART_RTODF_FLAG:  receiver time out detection flag
  *         - USART_CTSCF_FLAG: (not available for USART5, USART7 and USART8).
  *         - USART_BFF_FLAG:
  *         - USART_TDC_FLAG:
  *         - USART_RDBF_FLAG:
  *         - USART_PERR_FLAG:
