/**
  **************************************************************************
  * @file     at32f45x_pwc.h
  * @brief    at32f45x pwc header file
  **************************************************************************
  *
...
#ifndef __AT32F45x_PWC_H
#define __AT32F45x_PWC_H
...
#define PWC_WAKEUP_PIN4_FLAG             ((uint32_t)0x00000008) /*!< wakeup pin4 event flag */
#define PWC_WAKEUP_PIN5_FLAG             ((uint32_t)0x00000010) /*!< wakeup pin5 event flag */
...
#define PWC_WAKEUP_PIN_4                 ((uint32_t)0x00080000) /*!< standby wake-up pin4 */
#define PWC_WAKEUP_PIN_5                 ((uint32_t)0x00100000) /*!< standby wake-up pin5 */
...
/**
  ...
  *         - PWC_LDO_OUTPUT_1V2: system clock up to 160MHz.
  *         - PWC_LDO_OUTPUT_1V3: system clock up to 192MHz.
  * @note   none.
  */
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t swpen4               : 1; /* [19] */
      __IO uint32_t swpen5               : 1; /* [20] */
      ...
      __IO uint32_t swp4pol              : 1; /* [27] */
      __IO uint32_t swp5pol              : 1; /* [28] */
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t sw4ef                : 1; /* [3] */
      __IO uint32_t sw5ef                : 1; /* [4] */
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved1            : 1; /* [2] */
      __IO uint32_t clsw4ef              : 1; /* [3] */
      __IO uint32_t clsw5ef              : 1; /* [4] */
