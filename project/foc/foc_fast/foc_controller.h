...
#define WMAG_KI               1
#define WMAG_DIV              100
#define WMAG_LEAK_OUT_STEP    8           // 0.0078A/100µs ≈ 78A/s (与弱磁 PI 带宽 ~1.6Hz 匹配)
...
/*地址*/
/* AT32F456CEU7 Flash: 512KB total (0x08000000 ~ 0x08080000), sector size 2KB.
 * 用户参数区使用最后一个 sector: 0x0807F800 ~ 0x0807FFFF (与 flash_port.h 一致). */
#define FLASH_USER_COMMON_ADDR  0x0807F800U   // AT32F456 last 2KB sector
#define MOTORID0_RUN_DATA_ADDRESS (FLASH_USER_COMMON_ADDR)         // 0x0807F800
#define ERR_MESSGE_DATA_BASER (FLASH_USER_COMMON_ADDR)             // unused, alias to user sector
#define TEST_LIMIT_DATA       (FLASH_USER_COMMON_ADDR)             // unused, alias to user sector
