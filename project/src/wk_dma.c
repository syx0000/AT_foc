...
/**
  * @brief  init dma1 channel1 for "usart3_tx"
  * @param  none
  * @retval none
  */
...
/**
  * @brief  init dma1 channel4 for "usart1_rx"
  * @param  none
  * @retval none
  */
void wk_dma1_channel4_init(void)
{
  ...
  /* dmamux function enable */
  dmamux_enable(DMA1, TRUE);
  dmamux_init(DMA1MUX_CHANNEL4, DMAMUX_DMAREQ_ID_USART1_RX);
...
/**
  * @brief  init dma1 channel5 for "usart1_tx"
  * @param  none
  * @retval none
  */
void wk_dma1_channel5_init(void)
{
  ...
  /* dmamux function enable */
  dmamux_enable(DMA1, TRUE);
  dmamux_init(DMA1MUX_CHANNEL5, DMAMUX_DMAREQ_ID_USART1_TX);
